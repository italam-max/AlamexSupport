...
export default function UserDetailModal({ user, onUpdate, onDelete, onClose }) {
  ...
  const [confirmConfig, setConfirmConfig] = useState({
    ...
    title: '',
    message: '',
    action: null // La función a ejecutar si confirma
  });
  ...
  const addAccount = () => {
    if (!newAccount.app || !newAccount.username) {
        toast.warning("Falta nombre de app o usuario");
        return;
    }
  ...
  // REEMPLAZO DE ALERT: Eliminar cuenta específica
  ...
  // REEMPLAZO DE ALERT: Archivar Usuario
  ...
  // REEMPLAZO DE ALERT: Eliminar Usuario (Admin)
